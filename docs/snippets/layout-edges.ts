...
await toodle.assets.registerBundle("items", {
  textures: {
    apple: new URL("https://toodle.void.dev/img/ItemApple.png"),
    banana: new URL("https://toodle.void.dev/img/ItemBanana.png"),
    lemon: new URL("https://toodle.void.dev/img/ItemLemon.png"),
    cherry: new URL("https://toodle.void.dev/img/ItemCherry.png"),
  },
});
