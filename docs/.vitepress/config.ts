...
export default defineConfig({
  ...
  base: "/f849595b3ed13fc956fc1459a5cb5f0228f9d259",
  themeConfig: {
    ...
    editLink: {
      pattern: "https://github.com/vaguevoid/toodle/edit/main/docs/:path",
    },

    socialLinks: [
      { icon: "github", link: "https://github.com/vaguevoid/toodle" },
    ],
  },
  vue: {
    template: {
 ...
 *
 * import { Toodle, Quad } from '@vaguevoid/toodle'
